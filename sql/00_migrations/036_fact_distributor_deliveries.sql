...
Usage: Replaces [Data].[stg_DistributorDeliveries] in production. Historical 1404 rows are retained;
...
IF OBJECT_ID(N'[Data].[fact_DistributorDeliveries]', 'U') IS NULL
BEGIN
    CREATE TABLE [Data].[fact_DistributorDeliveries] (
...
BEGIN
    CREATE NONCLUSTERED INDEX IX_FactDistributorDeliveries_SourceFile
        ON [Data].[fact_DistributorDeliveries] (source_file)
